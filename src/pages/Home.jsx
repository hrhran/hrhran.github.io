...
export default function Home() {
  ...
  const experiences = [
    { company: "Tekion", role: "Software Engineer - II", period: "2022-Present", description: "Building FullStack apps along with AI workflows using MCP/LangChain etc" },
    { company: "tradewithMAK", role: "Software Engineer", period: "2022-2022", description: "Built dashboards and bots with MERN and python" },
  ...
  const projects = [
    ...
    { name: "AutoBlogger", link: "" },
    { name: "AgentForge", link: "" },
  ];

  const skills = ["Javascript", "Typescript", "React", "NodeJS", "Express",  "Python", "Go", "MongoDB", "MySQL", "Java", "Kafka", "Redis", "ElasticSearch", "Cypress", "Playwright", "Postgres", "Git", "Figma", "MCP", "AI Workflows", "RAG",];
    ...
    <div className="min-h-screen bg-black text-green-400 font-mono">
      <section className="h-screen w-full flex flex-col items-center justify-center text-center relative">
        ...
        <div className="flex space-x-4 mt-4">
          ...
          <a href="https://letterboxd.com/hrhran/" target="_blank"><SiLetterboxd size={26} className="text-green-400" /></a>
        </div>
      </section>
